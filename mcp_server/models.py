...
#   timestamp: 2025-06-28T15:21:34+00:00
...
class CertificateParameters(BaseModel):
    UDF1: str = Field(..., description='SAP', examples=['SAP/20XX/XXX01'])
...
class DpicrCertificatePostRequest(BaseModel):
...
class DpicrCertificatePostResponse(BaseModel):
...
class DpicrCertificatePostResponse1(BaseModel):
...
class DpicrCertificatePostResponse2(BaseModel):
...
class DpicrCertificatePostResponse3(BaseModel):
...
class DpicrCertificatePostResponse4(BaseModel):
...
class DpicrCertificatePostResponse5(BaseModel):
...
class DpicrCertificatePostResponse6(BaseModel):
